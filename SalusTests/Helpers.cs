...
internal static class Helpers
{
    ...
    public static void CreateDatabaseTables(DbContext context)
    {
        ...
        context.Database.ExecuteSql($"CREATE TABLE SalusDataChanges (Id VARCHAR(1000) NOT NULL PRIMARY KEY, UpdateDateTimeUtc VARCHAR(1000) NOT NULL, CompletedDateTimeUtc VARCHAR(1000), UpdateJson VARCHAR(10000) NOT NULL)");
    }
}
